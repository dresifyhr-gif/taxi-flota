  ...
  return (
    <article className="group flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] transition-all duration-300 hover:-translate-y-1 hover:border-accent/30 sm:rounded-[1.75rem]">
      <div className="relative">
        ...
        <span className="pointer-events-none absolute left-3 top-3 z-10 rounded-full bg-[#0a0f0b]/80 px-2.5 py-1 text-xs font-bold text-accent shadow-lg backdrop-blur">
          {vehicle.price}
        </span>
      </div>
...
export default async function RentalVehiclesPage() {
  ...
  return (
    <>
      ...
      {/* IZDVOJENO VOZILO */}
      {featured ? (
        <section className="bg-[#0a0f0b] pb-4">
          <Container>
            <div className="grid overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] lg:grid-cols-[1.05fr_1fr]">
              <div className="relative">
                ...
                <span className="absolute left-4 top-4 z-10 inline-flex items-center gap-1.5 rounded-full bg-accent px-3 py-1 text-xs font-bold text-[#0a0f0b]">
      ...
      {/* SVA VOZILA */}
      {rest.length > 0 ? (
        <section className="bg-[#0a0f0b] py-10 sm:py-14">
          <Container>
      ...
      {/* CTA */}
      <section className="bg-[#0a0f0b] pb-20">
        <Container>
