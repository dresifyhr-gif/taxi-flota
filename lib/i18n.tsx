...
const translations = {
  hr: {
    ...
    hero_desc: "FleetHub je taxi flota iz Zagreba koja direktno prima nove vozače za rad na Uber i Bolt platformama. Vodimo te kroz cijeli proces — od prijave do prvog radnog dana.",
    hero_desc_bold: "",
  ...
  en: {
    ...
    hero_desc: "FleetHub is a taxi fleet from Zagreb that directly accepts new drivers to work on Uber and Bolt platforms. We guide you through the entire process — from application to your first day driving.",
    hero_desc_bold: "",
